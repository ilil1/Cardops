...
BankChurners 기반 고객 분석·캠페인 서비스의 구현 범위와 데이터의 한계, 활동성 갭과 합성 시연 결과의 해석은 별도 문서에 정리했습니다. 향후 시간순 예측·평가와 월별 MLOps로 확장하기 위해 거래 시점과 카드 해지일을 연결하는 Synchrony 실험을 진행하고 있습니다.
