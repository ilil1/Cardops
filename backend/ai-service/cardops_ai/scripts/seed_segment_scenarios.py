...
실행: python -m cardops_ai.scripts.seed_segment_scenarios
"""
...
from cardops_ai.app.config import get_database_url
from cardops_ai.app.database import initialize_database
from cardops_ai.app.enums import (
...
from cardops_ai.app.models import (
    Campaign,
    CampaignEvent,
    CampaignTarget,
    Customer,
...
from cardops_ai.app.services.bulk_targeting_service import (
...
from cardops_ai.app.services.campaign_service import assign_experiment_group
from cardops_ai.scripts.db_safety import validate_local_database
