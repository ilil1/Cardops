...
from cardops_ai.app.enums import BulkTargetingSegment, UserRole
from cardops_ai.app.migration_runner import upgrade_database
...
from cardops_ai.app.schemas import BulkTargetingPreviewRequest
...
def test_every_segment_is_fully_configured() -> None:
    ...
    from cardops_ai.app.services.campaign_service import SEGMENT_PRIORITIES
...
def test_segment_check_constraint_allows_every_enum_value(tmp_path: Path) -> None:
    ...
    들어갈 수 있는지 직접 확인합니다.
    """
    from cardops_ai.app.models import BulkTargetingRun
